...
import { AddHsnDialog } from '@/components/config/AddHsnDialog';
import {
    AlertDialog,
    AlertDialogAction,
    AlertDialogCancel,
...
export default function HsnMasterPage() {
    ...
    // Data fetching
    const { hsnList, totalCount, isLoading, refetch, deleteHsn, profile } = useHsnMaster({
        page: currentPage,
        pageSize,
    ...
    const handleConfirmDelete = async () => {
        if (recordToDelete) {
            await deleteHsn.mutateAsync(recordToDelete.id);
    ...
    if (isLoading) {
        return (
            <PageContainer title="HSN Master">
    ...
    return (
        <PageContainer title="HSN Master" actions={headerActions}>
            <div className="space-y-6">
                    ...
                    <Table>
                        <TableHeader>
                            <TableRow className="bg-primary hover:bg-primary">
                                ...
                                <TableHead className="text-primary-foreground text-xs">Description</TableHead>
                            </TableRow>
                        </TableHeader>
                        <TableBody>
                            {hsnList.length === 0 ? (
                ...
                <div className="flex items-center justify-between">
                    <span className="text-sm text-muted-foreground">
                        Showing {hsnList.length === 0 ? 0 : ((currentPage - 1) * pageSize) + 1} to {Math.min(currentPage * pageSize, totalCount)} of {totalCount} entries
                    </span>
            ...
            <AlertDialog open={deleteDialogOpen} onOpenChange={setDeleteDialogOpen}>
                <AlertDialogContent>
                    <AlertDialogHeader>
                        ...
                        <AlertDialogDescription>
                            This will permanently delete this HSN. This action cannot be undone.
                        </AlertDialogDescription>
                    </AlertDialogHeader>
                    <AlertDialogFooter>
