...
import CRMPlanner from "@/pages/crm/CRMPlanner";
import CRMDashboard from "@/pages/crm/CRMDashboard";
import PipelineIntelligence from "@/pages/crm/PipelineIntelligence";
import CustomerIntelligence from "@/pages/crm/CustomerIntelligence";
import TaskControl from "@/pages/crm/TaskControl";
import RevenueGrowth from "@/pages/crm/RevenueGrowth";
import CRMOperations from "@/pages/crm/CRMOperations";
import { CRMIntelligence } from "@/pages/crm/CRMIntelligence";
                      ...
                      <AppLayout>
                        <Routes>
                          ...
                          <Route
                            path="/crm/planner"
                            element={
                              <RoleBasedRoute allowedRoles={['superadmin', 'admin', 'salesperson']}>
                                <CRMPlanner />
                              </RoleBasedRoute>
                            }
                          />
