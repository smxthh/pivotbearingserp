...
const formSchema = z.object({
    doc_prefix: z.string().default('GSTJV/25-26/'),
...
interface GSTJournalDialogProps {
    open: boolean;
    onOpenChange: (open: boolean) => void;
}

export function GSTJournalDialog({ open, onOpenChange }: GSTJournalDialogProps) {
    ...
    const { prefixes: dbPrefixes, defaultPrefix } = useVoucherPrefixesForType('GST Journal');
        ...
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent className="sm:max-w-[1000px] max-h-[90vh] overflow-y-auto">
                <DialogHeader className="bg-primary text-primary-foreground -mx-6 -mt-6 px-6 py-4 rounded-t-lg">
                    <DialogTitle className="text-lg font-semibold">GST Journal</DialogTitle>
                </DialogHeader>
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-5 pt-2">
                    ...
                    <div className="grid grid-cols-12 gap-4">
                        ...
                        <div className="col-span-6 space-y-2">
                            ...
                            <Input {...register('remark')} placeholder="Enter remark" className="text-xs" />
                        </div>
                    </div>

                    {/* Table */}
                    <div className="space-y-3">
                        <Label className="text-sm font-medium">GST Journal Details :</Label>
